...
const int fan_pwm_pin_output[NUMBER_OF_FANS] = {6,7,8,44,45,46};     // Blue Wire.  Uses PWM registers and output   TODO: CHANGE PIN 11 to 44
...
void setup() {
  ...
  OCR4A = fan[0].fan_pwm_percent*320 / 100;
  OCR4B = fan[2].fan_pwm_percent*320 / 100;
  OCR4C = fan[3].fan_pwm_percent*320 / 100;
  OCR5C = fan[3].fan_pwm_percent*320 / 100;
  OCR5B = fan[4].fan_pwm_percent*320 / 100;
  OCR5A = fan[5].fan_pwm_percent*320 / 100;
